...
Namespace UserDataSetTableAdapters
    ...
    Partial Public Class UserTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `User` SET `Password` = ?, `UserName` = ? WHERE ((`UserID` = ?) AND ((? = "& _ 
                "1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `UserName` IS NUL"& _ 
                "L) OR (`UserName` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT UserID, [Password], UserName FROM [User]"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_UserID As Integer, ByVal Original_Password As String, ByVal Original_UserName As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Password As String, ByVal UserName As String, ByVal Original_UserID As Integer, ByVal Original_Password As String, ByVal Original_UserName As String) As Integer
            If (Password Is Nothing) Then
